...
non-local guesses:
	 -it/unibo/pslab/peers/Peers.TieToSingle#
	 -it/unibo/pslab/multiparty/MultiParty.TieToSingle#
	 -TieToSingle#
	 -scala/Predef.TieToSingle#
offset: 679
...
object Language:
  ...
  inline def commPerPeer[From <: TieTo.TieToMultiple[To], To <: TieToS@@ingle[From]](using
      lp: LocalPeer
