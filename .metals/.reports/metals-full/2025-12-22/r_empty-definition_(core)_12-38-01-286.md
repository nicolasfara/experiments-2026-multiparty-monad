error id: file://<WORKSPACE>/core/src/it/unibo/pslab/multiparty/Algebra.scala:it/unibo/pslab/multiparty/MultiParty.on#
file://<WORKSPACE>/core/src/it/unibo/pslab/multiparty/Algebra.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -it/unibo/pslab/peers/Peers.TieTo.on#
	 -on#
	 -scala/Predef.on#
offset: 584
