...
non-local guesses:
	 -it/unibo/pslab/peers/Peers.LocalPeer#
	 -LocalPeer#
	 -scala/Predef.LocalPeer#
offset: 171
...
object Language:
  @nowarn
  inline def on[P <: Peer](using lp: Loca@@lPeer)[V](body: PeerScope[P] ?=> MultiParty[V] | V): MultiParty[V on P] =
  ...
  inline def commPerPeer[From <: TieToMultiple[To], To <: TieToSingle[From]](using
      lp: LocalPeer
